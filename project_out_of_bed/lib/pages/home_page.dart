...
class ActivityLabel extends StatelessWidget {
  ...
  // Widget interne pour la barre d'interaction (J'aime/Commentaires/Enregistrer)
  Widget _buildInteractionBar() {
    return Container(
      padding: const EdgeInsets.symmetric(vertical: 10),
      // Couleur de fond jaune pâle comme dans l'image
...
class TabContentPage extends StatelessWidget {
  ...
  List<ActivityLabel> _buildActivities() {
    return [
      ...
      // Ajouter une deuxième carte pour prouver le défilement
      ActivityLabel(
